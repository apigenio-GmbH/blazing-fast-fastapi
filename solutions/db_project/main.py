...
from src.repositories import ItemRepo, StoreRepo

# Some configuration added
app = FastAPI(title="Sample FastAPI Application for Demo",
              description="Nice to show how easy an API is created!",
              version="1.0.0", )
